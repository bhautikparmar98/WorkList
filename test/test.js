...
describe("WorkList app \n", function () {
  ...
  it("Delete", async function () {
    ...
    ${ ul3} [0].innerText === "Prepare schema" && ${ul3} [1].innerText === "Attend meeting" && ${ul3} [2].innerText === "schedule a meeting" &&
      getComputedStyle(document.querySelector('.card1 #deleteBtn1')).display === "" && getComputedStyle(document.querySelector('.card3 #deleteBtn1')).display === "none" &&
      getComputedStyle(document.querySelector('.card1 #deleteBtn2')).display === "" && getComputedStyle(document.querySelector('.card3 #deleteBtn2')).display === "none" &&
    ...
    ${ ul3} [0].innerText === "Prepare schema" && ${ul3} [2].innerText === "schedule a meeting" &&
      getComputedStyle(document.querySelector('.card3 #deleteBtn1')).display === "" && getComputedStyle(document.querySelector('.card1 #deleteBtn1')).display === "none" &&
      getComputedStyle(document.querySelector('.card3 #deleteBtn2')).display === "" && getComputedStyle(document.querySelector('.card1 #deleteBtn2')).display === "none"`
    );
